...
WVP视频平台(国标28181)未授权接口存在未授权  
  
访问，攻击者可远程获取敏感信息，造成信  
息泄露。  
## Poc  
```
http://127.0.0.1/xxx/xxxxxx/xxxxxx/configInfo
```  
## 漏洞复现  
  
![](https://mmbiz.qpic.cn/mmbiz_png/w0DeFbFI15y3Qv9lmSrpcJibhPutRakvgWEicRcO14mbKls9HNd93nSEEQmbVGSOwdyd7N6ImqKCicgEwKwp6NauA/640?wx_fmt=png&from=appmsg "")  
