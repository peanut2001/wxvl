...
      
友数聚科技-CPAS审计管理系统showGroupImage  
接口存在任意文件读取漏洞，未经过身份验证的远程攻击者可通过该漏洞读取系统重要文件、数据库配置文件等等，导致网站处于极度不安全状态。  
  
![](https://mmbiz.qpic.cn/mmbiz_png/nvJGLMmlzsEUXV0DPWyIFeggHUSw3fVqWHuT7t6eSGCiarvVpdmPIgpnhb9t8YWE1wvG6yapydGV9ibqut6iaPHaQ/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/nvJGLMmlzsEUXV0DPWyIFeggHUSw3fVqgIargibkdxSXIgJs5TsvUqu3STvMNY8niczXXygPqMVIcXTaCbqk9Qmg/640?wx_fmt=png&from=appmsg "")  
...
[漏洞情报(已验证) | 0 Day 友加畅捷U+财会通 RepFile.ashx 存在任意文件读取漏洞](https://mp.weixin.qq.com/s?__biz=MzUyNzk1NjA5MQ==&mid=2247483995&idx=1&sn=9a3e91f92be209b55a8bfff60e5cc026&scene=21#wechat_redirect)  
  
  
[漏洞情报 | 0 Day 科汛新职教网校系统 SaveRoomGroupList 存在SQL注入漏洞](https://mp.weixin.qq.com/s?__biz=MzUyNzk1NjA5MQ==&mid=2247483948&idx=1&sn=06d11d4faaa79a8a12762909242e1fbc&scene=21#wechat_redirect)  
...
[漏洞情报(已验证) | 0 Day 用友时空KSOA workslist.jsp 存在SQL注入漏洞](https://mp.weixin.qq.com/s?__biz=MzUyNzk1NjA5MQ==&mid=2247483861&idx=1&sn=1bd616a40b6c48a84b334d833b76f4c2&scene=21#wechat_redirect)  
  
  
[漏洞情报(已验证) | 0 Day 万户OA checkSQL_httprequest 存在SQL注入漏洞](https://mp.weixin.qq.com/s?__biz=MzUyNzk1NjA5MQ==&mid=2247483837&idx=1&sn=022196c51de93d44c3b76c76043b6743&scene=21#wechat_redirect)  
...
[漏洞情报(已验证) | 1 Day 万户OA InfoTemplateEdit 存在SQL注入漏洞](https://mp.weixin.qq.com/s?__biz=MzUyNzk1NjA5MQ==&mid=2247483823&idx=1&sn=4496047226b2f127e788a8e376a67b0d&scene=21#wechat_redirect)  
