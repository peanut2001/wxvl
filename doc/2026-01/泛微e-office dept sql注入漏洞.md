...
安全艺术
                    安全艺术  安全艺术   2026-01-20 01:00  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5U0bFicWicnkMz3qicMxK0LcHAiayHaqDmA3vlkdnkejWAk0aO4nQlicOEGQ/640?wx_fmt=png&from=appmsg "")  
  
sqlmap一把梭  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA59LrroSmkBOeqbqnPNAntxWIVIn0Zw1YBNWhffiaF5OsiaUfa3b2b4Kpg/640?wx_fmt=png&from=appmsg "")  
...
**选择这个工具的最重要的原因就是先识别指纹，然后根据指纹去扫描对应POC，高效高质且较好维护。实战配个代理池，产出还是很可观的，记得第一次用它参与国护时，第一天就进了某央企运维内网。**  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5UPoeGicqa9rXuQa0iaLMOKrNVkqyVMrvHG71nRiao7OsdiclAnDqLZZCpQ/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5royiaicAUc9wRXhZAclm05JY66KibHI3kZNouswYQDiaSk7ypYUJZkZBHg/640?wx_fmt=png&from=appmsg "")  
  
**workflow（懂得都懂，纯体力话，也是坚持写了近2k条）。**  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5vRZVv1iak8XTgZ8iauktPeGArQGvkbuJZ0z9JkR1pzNRicZ7TEYuiaGABg/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5fibbdMk4zzmnwjlgUvuuA0DsYd1RxEbfcOZpkNfqlYBkyUoj3nBib4Xw/640?wx_fmt=png&from=appmsg "")  
## 1.2. 目录扫描  
  
目录扫描：主要是针对SRC挖掘和HVV项目中碰到的比较多的需要路径信息的指纹进行补充的，新增了很多发现频率非常高的springboot相关的接口信息，并通过指纹信息精准匹配，基本扫到就可以出洞。  
  
指纹高亮：来自圈友提的需求，网站指纹识别输出，原版是统一输出的，没有任何区别，改版后新增了重点指纹（SRC和HVV漏洞高爆发点）高亮显示。  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5DzW8U93oMzoJ0CAia9G5tJX8hLjns8Tlrb0JWB5HnUtBegHJoQEbGUg/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5FiaL19JDtCs1n1JTqLB5QGicRnT1HKXxj46Am8yMdB7ecM14khbvPBag/640?wx_fmt=png&from=appmsg "")  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA53JTqlIb32Tq7hHGleTkw326ChZMgvn8TMicey5saxsFn1e248t8McAQ/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5w2aNmdvZ1m43EVtWwSeDlNgRMQSNXjYAibSGcOUzlPENdtQpu343rbg/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5MomdnPRvsET4BCNrTK3mQLDbCzMf8VUEwVUtfoHFksiaFb6bw0VZBBw/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5rYCY97hHu6TqncbicSPvasYU1POGFkkMGqNPV11zUALeYSIG2qgJibTg/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/X5epWh2K2OoFGicBSlsZpkqZibXHCYEdA5Sgmz73Lw2uZGITyPoSr4zv8DEBZnyQ8QMMibPOeHOUIPma4ExxDalUA/640?wx_fmt=png&from=appmsg "")  
