...
中铁13层打工人
                    中铁13层打工人  陌笙不太懂安全   2026-01-29 09:58  
...
```
本文作者:中铁13层打工人
原文链接:https://forum.butian.net/share/4634
```  
# 前言：  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQVbRpgicK0cFMAFmHaKs19icX0bjuFsWGotBvvm7SVLOO3N9esapkNbEw/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQ2yth6WW7WkmIoEqT4mcGPg5FklBS7087T1G10rBswJdtfGovt5Kh4Q/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQgLTnibOwjEYRov5UIWibMVm5xWIM8y2hdO2r3NgAahvwzXiaHiaQibW5CibQ/640?wx_fmt=png&from=appmsg "")  
  
下来正常输入新密码点击下一步抓包，继续修改响应值，成功重置密码。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQ469vLXbia9omNc9M0FRToSPvpJJ5lZwgSXwiczN4Ba0lKrzDbgxfI0mw/640?wx_fmt=png&from=appmsg "")  
### 1.2挖掘思路  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQ4KQSMkiahVcwsrBEWibmg6Yvslu7eeMksnbKHrjHHaGgW5tAhjcCICKQ/640?wx_fmt=png&from=appmsg "")  
  
登录test1账户，随后构建payload，id修改为要修改的账户的id  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQpIYaB8LVPfj1437MlQstVZCSBy5LWDdvzWmqTxuROlkcC6nwvbC0aQ/640?wx_fmt=png&from=appmsg "")  
  
发送请求获取key，成功获取key值后即可修改目标账户密码。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQVsa9ic83QWjTGMog2EHHw9pfEIb77XYwXDesIuux2KGLYC2VB8VciaSw/640?wx_fmt=png&from=appmsg "")  
### 2.2挖掘思路  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQKYKr69d1qWV9lLepZMWQAqLgDssO274ZezMdyII4TDFjAM2U6VwMUw/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQexxtVIxW8TZ8hLxo88VVlJibFWGa06sbkzCUqp08se424sAfmwm2UtA/640?wx_fmt=png&from=appmsg "")  
  
在响应体中，包含如下参数："showResetPassword": false,"showModifyEmails": false，参数值表示用户角色禁用了密码重置和电子邮件修改选项。在burp中对该流量包进行拦截，并修改响应包。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQzHfqzcKtQ9kK2Y9TRCiasrRHeL9EplCc2rLy9uRZvtcXr6M0KUL3Mlg/640?wx_fmt=png&from=appmsg "")  
  
刷新页面后会发现两个新选项：  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQgeLWEhSUUnHY3zEGicnfm5VvdJtJA3faTx08akNcetFGOO56Ww6PCwA/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQpiafZiaePPcpIZg8MtoJz80fBop7zQphpn7k3I8mE98uPaEkdSBE6sjQ/640?wx_fmt=png&from=appmsg "")  
  
访问后发现密码重置成功  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQ2O810icgCJ5IFjwvCPaNP6icAqwKhvLNynRfIsbqa9OG9ZHicAYyMTz6A/640?wx_fmt=png&from=appmsg "")  
  
拦截密码重置接口包，发现请求中包括用户的数字ID，其请求体仅包含：{ "userId": 9438868, "resetAccessKey": false }，没有其他的鉴权参数。该端点未检查当前会话是否具备对 userId 的操作权限，也未校验当前用户权限。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQ1U8OeQStrNQK7TOWUD74ZDHxll1UJVbMLbOtsd6GLvAdhVicb6ib81Og/640?wx_fmt=png&from=appmsg "")  
  
重新抓包，将USERID修改为另一个账户USERID，密码修改成功并成功登陆。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQ48SJibe6TU906EvUVkhzE51nbEYYLovkYt9DBUwVZE20I8XzYOGpueg/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQrmCywaoeDibsrvIGW9dTEhVoz8l9icTH00jqIeb5I140JZQeT9qTymyw/640?wx_fmt=png&from=appmsg "")  
  
拦截请求，发现接收验证码的邮箱为请求包中的参数，而此参数可控，直接篡改为攻击者的邮箱，此时攻击者成功接收邮箱验证码。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQfETiaWuSR2eZ90nUcl3kcgvaW0mTfzOgZ5iaMZpOcDxINysCvNX2Zrzw/640?wx_fmt=png&from=appmsg "")  
  
提交验证码后抓包修改其中邮箱为获取验证码的邮箱。此时仅校验了验证码与邮箱是否绑定，只要输入正确的验证码即可通过验证。下来正常执行 3、4 步即可成功重置该账号的密码。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQpfLpibmOTXfz9eSLco5F1ICJxWGTKf41duibspDkx6fnVoQScrmts7Eg/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQC9d2jjCzA4FsO6IqaKdyZiatW2MI4tUJjyb17eeibWjw33VYOWMeZo5A/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQGFfcmiaqvE4maMjia4a01SrpXH2oCiaB0jnJz66Q9HhISXWIEM2cCZJmQ/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQWLJDd1SKCZFpgpTNt6e8ibs21qUsxRDT2ibBdhpgIKQ7MIvQ2ZGco81g/640?wx_fmt=png&from=appmsg "")  
  
当用  
户已经验证过验证码，在正确验证有效期内攻击者同时做重置密码操作，此时可以利用令牌未失效的情况下实现任意密码重置。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQSzTEBD0sfW4asmuib3czibWhzRjK2kUQsOFOrxicZVDBNg9BgEONReibYg/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQh4PpXUQEUanSIia7Ls3X4PhCKeQz7VfdRssOLDc8AlZ0RwwAPd1TRicA/640?wx_fmt=png&from=appmsg "")  
  
输入正确验证码后会触发校验接口，获取重置当前密码的凭证。另一个账号同样按以上方式操作，利用获取到正确凭证的间隙。回到攻击账号输入新密码抓包。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQxldjNmYib3KuwY5q2nXKSZUPl0UWMENovumnMaJFqUgiavVoq0WeN0Pg/640?wx_fmt=png&from=appmsg "")  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/f7yXib8mBCO6rVcVuXLWkibndNfzu8WZgQHrR4qmc74a71w5pCGgCp1IGJnxrvvGrOPudnG2ZGjorbTSGJzibSoww/640?wx_fmt=png&from=appmsg "")  
