...
原创 升斗安全XiuXiu
                    升斗安全XiuXiu  升斗安全   2026-02-06 11:58  
...
****  
上一节[【服务端漏洞-访问控制缺失-第二章第二节】别找了，高危漏洞有时就藏在最显眼的地方](https://mp.weixin.qq.com/s?__biz=MjM5MzM0MTY4OQ==&mid=2447797878&idx=1&sn=20e404cd7640867d43ffc148c1dcf3d1&scene=21#wechat_redirect)  
中，我们了解了一些配置文件可能泄露一些路径，且这有可能是系统有  
访问控制权限缺失的突破点。但如果这些常见的robots.txt中，没有泄露什么可用路径，我们又该如何继续呢？  
...
通过阅读该系统的源码内容，发现系统中存在这样一个逻辑，就是告知了系统，如果当前登录的是管理员，就会跳转到目录   
/admin-uw0ce9  
   
...
关于  
访问控制权限缺失  
的另一种路径发现、挖掘方式，今天就分享到这了。  
后续这边还会继续分享有关服务端的更多漏洞原理、利用、挖掘方式，感兴趣的可以点点关注。  
